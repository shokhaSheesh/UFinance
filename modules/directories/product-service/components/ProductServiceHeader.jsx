...
import { ChevronDown, FolderPlus, Package, Plus } from 'lucide-react'

/**
 * Шапка справочника товаров и услуг: заголовок с количеством позиций и
 * «Создать» — меню из двух пунктов (позиция / группа). Раньше меню было
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 rounded-xl p-1.5" align="end" sideOffset={6}>
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-900">{tc('create')}</span>
              </DropdownMenuItem>
              <DropdownMenuItem
