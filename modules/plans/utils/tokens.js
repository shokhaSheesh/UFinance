...
export const BUDGET_TOKENS = {
  ...
  accent: '#0e73f6', // фирменный синий: рамка активной плановой ячейки
  accentWash: 'rgba(14, 115, 246, 0.04)', // фон планируемых ячеек
  danger: '#ef4444',
...
export const BUDGET_ROW_CLASSES = {
  // обычная статья
  leaf: 'bg-white',
  // раздел верхнего уровня (Доходы / Расходы / потоки) — лёгкий фон, чтобы разделы читались
  section: 'bg-slate-50',
  // расчётные строки (прибыль, рентабельность, остатки) — выделены как итоги
  result: 'bg-[#f5f8ff]',
  // планируемая плановая ячейка: бирюзовая заливка + рамка под курсором
  editable:
    'bg-[rgba(14,115,246,0.04)] cursor-pointer hover:shadow-[inset_0_0_0_1px_#0e73f6]',
