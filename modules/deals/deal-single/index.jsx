...
export default observer(function DealSinglePage() {
  ...
  const summeryCards = useMemo(() => dealData || null, [dealData])
    ...
    <div className="flex overflow-hidden overflow-y-auto flex-col space-y-4 fixed left-[80px] top-[60px] w-[calc(100%-80px)] h-[calc(100%-60px)]">
      ...
      <div className="min-w-[920px] max-w-[1920px] gap-2 xl:gap-4 px-3 grid grid-cols-4">
        ...
        <div className="bg-white rounded-xl p-4 xl:p-6 flex flex-col shadow-[0_8px_18px_rgba(118,164,172,0.1)]">
          ...
          <div className="border-b border-gray-100 my-2 xl:my-3" />
        ...
        <div className="bg-white rounded-xl p-4 xl:p-6 flex flex-col shadow-[0_8px_18px_rgba(118,164,172,0.1)] overflow-hidden">
          <div className="flex items-center justify-between mb-2 xl:mb-4">
            ...
            <button
              onClick={() => { handleCreateOperation(); setActiveTab('receipts'); }}
        ...
        <div className="bg-white rounded-xl p-4 xl:p-6 flex flex-col shadow-[0_8px_18px_rgba(118,164,172,0.1)] overflow-hidden">
                ...
                <div className="flex flex-col bg-white">
                  <label htmlFor="accrual" className="flex p-3 items-center gap-2 cursor-pointer hover:bg-neutral-50">
                    <CustomRadio
                      ...
                      id="accrual"
                      value="accrual"
                      checked={accounting === 'accrual'}
                      onChange={(e) => { sealDeal.setState('accounting', e.target.value); setShowAccounting(false); }}
                    />
          ...
          <div className="flex flex-1 items-end gap-1.5 xl:gap-2">
            <div className="flex flex-col flex-1 min-w-0">
              <div className={styles.profitBarDot} style={{ backgroundColor: '#12B76A', flexShrink: 0, width: '4px', height: '4px', borderRadius: '50%', marginBottom: '2px' }} />
            ...
            <div className="flex flex-col flex-1 min-w-0">
              <div className={styles.profitBarDot} style={{ backgroundColor: '#FFC609', flexShrink: 0, width: '4px', height: '4px', borderRadius: '50%', marginBottom: '2px' }} />
        ...
        <div className="col-span-3 bg-white rounded-xl shadow-[0_10px_10px_rgba(118,164,172,0.1)]">
          <div className="flex flex-col sticky top-16 z-10">
            <div className="flex border-b h-16 border-neutral-100 rounded-t-xl mb-0">
              {[
                { key: 'products', label: t('tabs.products'), count: summeryCards?.products_count ?? 0 },
                { key: 'receipts', label: t('tabs.receipts'), count: summeryCards?.receipts_count ?? 0 },
                { key: 'expenses', label: t('tabs.expenses'), count: summeryCards?.expenses_count ?? 0 },
                { key: 'shipments', label: t('tabs.shipments'), count: summeryCards?.shipments_count ?? 0 },
              ].map(({ key, label, count }) => (
                <button
                  key={key}
                  className={`font-semibold text-mini xl:text-xs px-3 xl:px-5 py-3 xl:py-4 cursor-pointer uppercase border-b-2 bg-transparent border-none relative transition-all hover:text-neutral-800 truncate ${activeTab === key ? 'text-neutral-900 border-neutral-900 font-bold' : 'text-neutral-400 border-transparent'}`}
