              ...
              <table className="w-full table-fixed">
                <tbody className="divide-y divide-gray-50 ">
                  {roles.map((role, index) => (
                    <tr key={role.guid || role.id} onClick={() => router.push(`/settings/role/${role.guid}?role_name=${role.name}`)} className="hover:bg-gray-50 transition-colors cursor-pointer group">
