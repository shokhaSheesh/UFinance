...
export default observer(function CashFlowByQueryReportPage() {
  ...
  const { data: cashFlowDataList, isLoading: isLoadingCashFlow, isFetching: isFetchingCashFlow } = useQuery({
    queryKey: ["cash_flow_by_query", filterData],
    queryFn: () => apiClient.invokeFunction({ method: "cash_flow_by_query", data: filterData }),
