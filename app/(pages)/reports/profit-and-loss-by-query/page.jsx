...
const ProfitAndLossByQueryPage = observer(() => {
  ...
  const { data: profitAndLossDataList, isLoading: isLoadingProfitAndLoss, isFetching: isFetchingProfitAndLoss } = useQuery({
    queryKey: ["profit_and_loss_by_query", filterData],
    queryFn: () => apiClient.invokeFunction({ method: "profit_and_loss_by_query", data: filterData }),
...
export default ProfitAndLossByQueryPage
