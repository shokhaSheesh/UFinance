...
(sinov
muddati bilan) ${validFrom} dan ${validTo} yilgacha tashkil etiladi. Shartnoma uchun to’lov:
...
<p class="article">
  1.3 To‘lovning huquqiy maqomi <br/>
  - Mazkur to‘lov “Qabul uchun oldindan to‘lov” hisoblanib, Shartnoma tuzilgan yil uchun amal
  qiladi.<br/>
...
va quyidagi xizmatlarni amalga oshiradi:</p>
<p class="article">2.1.1. “Bajaruvchi” tomonidan maktab O’zbekiston Respublikasining Davlat Ta’limi Standarti
...
ma’muriyati va ota-onalarrning takliflarini inobatga olgan holda tashkil etiladi.</p>
<p class="article">2.1.2. DTSga asosan Maktab o’quvchilarining bilim va ko’nikmalarini bosqichma-bosqich
...
attestatsiyalar ham o’tkaziladi.</p>
<p class="article">2.1.3. “Bajaruvchi” o’quv jarayonini O’zbekiston Respublikasi fuqarolik kodeksi,
“Xo’jalik
yurutuvchi subektlar faoliyatining shartnomaviy-huquqiy bazasi to’g’risida”gi,
“Ta’lim to’g’risidagi
qonunlar, O’zbekiston Respublikasi Prezidentining 15.09.2017yildagi № PQ- 3276 sonli “Nodavlat
...
tartib va odob-ahloq qoidalari va boshqa lokal xujjatlar asosida amalga oshiradi.</p>
<br/>
<p class="article">2.1.4. O’n bir yillik majburiy umumiy o’rta ta’lim tizimiga izchil o’tishni ta’minlash,
takomillashtirilgan davlat ta’lim standarti va o’quv dasturlari asosida maktab bitiruvchilariga Davlat
namunasidagi Аttestat (Shahodatnoma) beriladi.</p>
...
<p class="article">
  ...
  tomonlama bekor qilish huquqiga ega. (Bunday hollarda “Buyurtmachi” tomonidan e’tirozlar
  bildirilmaydi va barcha javobgarlikni o’z zimmasiga oladi.)
  </p>
  <p class="article">
...
tarmoqlarda tarqatilishida ishtirok etgan shaxslar ustidan tegishli organlariga murojaat qilish huquqiga
ega.
</p>
<p>
...
siyosatidan kelib chiqgan holda Shartnomaga muvofiq mijozlar uchun chegirmalar e’lon qilishi
mumkin.
</p>
...
<p class="article">4.2. Har bir o'quvchini maktab ruhshunosi va malakali o'qituvchi suhbati va imtihoni asosida maktabga qabul qilish jarayonini tashkillashtirida.</p>
...
<p class="article">4.5. Maktab sinflarda o'quvchilar sonini yigirma to'rt (24) kishidan oshmagan holda dars jarayonini tashkillashtiradi.</p>
<p class="article">4.6. Maktab tomonidan o'quvchilarga birinchi tibbiy xizmat ko'rsatish (bunda o'quvchi jarohat olganda birinchi tibbiy yordam ko'rsatiladi va o'quvchining ota-onasi habordor qilinadi. Agarda Ota-ona (Vasiy/Homiy) o'z vaqtida maktab binosiga etib kelmasa Maktab 103 ishonch telefoniga murojaat qiladi. O'quvchilarning yillik emlash ishlari ota-ona (Vasiy/Homiy) zimmasida qoladi va amalga oshiriladi.</p>
...
<p class="article">4.8. O'quvchining mazkur Shartnomaning 4.7-bandiga asosan Tibbiyot birlashmasi yoki davolangan muassasadan kasalligi to'g'risidagi Tibbiy ma'lumotnomasini olgan kundan 2 (ikki) ish kuni davomida maktab Bosh ma'muriy idorasi, shartnomalar bilan ishlash bo'limi mutaxassisiga topshirishi lozim. (bunda o'quvchining Tibbiy ma'lumotnomasiga asosan qayta hisob-kitob ishlarini to'g'ri amalga oshirish uchun mazkur muddat ko'rsatilgan).</p>
...
<p class="article">4.11. Maktab tomonidan ushbu shartnomaga o'zgartirish va qo'shimchalar kiritish to'g'risida "Buyurtmachi"ni o'zgarish va qo'shimchalar to'g'risida yozma ravishda 3 kunlik muddatda ogohlantirida.</p>
...
<p class="article">5.1. Ota-ona(Vasiy/Homiy) maktabning har bir ichki xujjatlari (maktab Nizomi, ichki tartib va odob-axloq qoidalari, maktab shartnomasi hamda maktab faoliyatini tashkil etish bilan bog'liq litsenziya (guvohnoma), qo'shimcha xizmatlar va maktab faoliyati) bilan tanishib chiqish huquqiga ega.</p>
...
<p class="article">5.3. Ota-ona(Vasiy/Homiy) Maktab ma'muriyatining pedagogik kengashlarida ishtirok etish, zarur hollarda ta'lim masalalari bo'yicha o'z takliflarini maktab ma'muriyatiga kiritida.</p>
<p class="article">5.4. Ota-ona (Vasiy/Homiy) maktabning xisob raqamiga xayriya (Homiylik) pullarini qo'shish.</p>
...
<p class="article">6.2. Maktabda o'quvchining xatti-xarakati uchun maktab ichki tartib va odob-ahloq qoidalarida belgilangan qoidlari doirasida javobgar bo'ladi.</p>
...
<p class="article">6.6. O'quvchining uy vazifalarini doimiy ravishda kuzatib borish, shuningdek o'qituvchilarning talablari va tavsiyalariga rioya qilish xatti-harakatlari haqida maktab ma'muriyatiga habar berish;</p>
<p class="article">6.7. Farzandining shubhali xatti-harakatlari haqida maktab ma'muriyatiga o'z vaqtida habar berishi mumkin.</p>
...
<p class="article">6.10 Har bir ota-ona agar ularning yashash manzili, bankdagi hisob raqami yoki rekviziti, elektron manzili xamda telefon raqami o'zgarsa, 48-soat ichida ta'lim olayotgan maktab ma'muriyatiga yozma ravishda ma'lumot berishi;</p>
...
<p class="article">6.12 Ota-ona(Vasiy/Homiy) farzandini maktab nizomida belgilab quygan soatda maktabga o'z vaqtida olib kelishi (soat 8.30 dan kech qolmagan holda) va olib ketishini (soat 17.00) ta'minlash (maktab transportidan foydalanuvchilar bundan mustasno);</p>
<p class="article">6.13 Ota-ona(Vasiy/Homiy) quyidagilar to'g'risida maktab ma'muriyatiga yozma ravshida ma'lumot berishi kerak:</p>
<ul>
...
<p class="article">7.1. Shartnomaga muvofiq (ta'lim xizmatlariga) kelishilgan to'lov miqdori bir o'quv yili uchun 0 so'mni tashkil qiladi. To'lovni oyma-oy bo'lib to'lashga yo'l qo'yiladi. Bunda bir oy uchun to'lov miqdori 0so'mni tashkil qiladi.</p>
...
<p class="article">7.7 Shartnoma 3 tomonlama tuzilgan xollarda "Buyurtmachi" uchun to'lovni "Uchinchi shaxs" tomonidan amalga oshirishga mazkur shartnoma va qonun hujjatlariga muvofiq yo'l qo'yiladi.</p>
<p class="article">7.8 Mazkur shartnoma imzolanga kundan boshlab 3 (uch) bank ish kuni davomida "Buyurtmachi" tomonidan to'lov to'liq miqdorda amalga oshirilmasa, bir tomonlama shartnoma bekor qilinishi mumkin.</p>
...
<p class="article">7.10 Mazkur shartnoma tomonlarning kelishuviga ko'ra muddatidan oldin yoki "Bajaruvchi" tomonidan bir tomonlama bekor qilingan taqdirda, Pul mablag'larini qaytarish (shartnoma uchun to'lov puli bundan mustasno) mazkur shartnomaga asosan joriy o'quv yilining yakuni bo'yicha 25 Iyun kuni amalga oshiriladi. "Buyurtmachi" tomonidan amalga oshirilgan to'lovning, qanday shaklda to'langanidan qat'iy nazar naqd pulda qaytarilmaydi.</p>
<p class="article">7.11 O'quvchi Maktab ichki tartib qoidalarini qo'pol tarzda buzishi (Mushtlashish, Chekish, Milliy qadriyatatlarga mos kelmagan video materiallarni ko'rish, olib yurish va x/k) sababli yohud Buyurtmachining tashabbusi bilan Shartnoma bekor qilinsa "Bajaruvchi" tomonidan shartnomaga muvofiq pul mablag'larini "Buyurtmachiga" 90 bank ish kuni mobaynida to'liq qaytarib beriladi.</p>
<p class="article">7.12. O'quvchi Maktabga sababli yoki sababsiz kelmagan taqdirda to'lov summasida hech qanday chegirma va qayta hisoblash yuzaga kelmaydi.</p>
...
<p class="article">8.1. Mazkur shartnomani quyidagi holatlarda muddatidan oldin bekor qilish mumkin: Tomonlarni o'zaro kelishuviga muvofiq; Buyurtmachining arizasiga muvofiq (bunda o'quvchi choraklik baholarini yopgan bo'lishi shart); O'zbekiston Respublikasining amaldagi qonunchiligida nazarda tutilgan asoslarda tomonlardan birining tashabbusiga ko'ra.</p>
...
<p class="article">8.3. Bundan tashqari "Bajaruvchi" quyidagi holatlarda tegishli ogohlantirishdan so'ng mazkur shartnoma shartlarini bajarishni rad qilishi mumkin: Agar "Buyurtmachi" shartnomada ko'rsatilgan xizmatlar uchun to'lov muddatini belgilangan muddatlardan ortiq kechiktirgan bo'lsa; "Bajaruvchi" qaroriga ko'ra, O'quvchi quyidagi holatlarda maktabdan chetlashtirilishi mumkin: bir necha bor intizom buzushi (Bajaruvchi nizomini bajarmaslik yoki talablariga rioya qilmaslik, ichki tartib qoidalarini buzush va ta'lim faoliyatiga tegishli boshqa normativ hujjatlariga amal qilmaslik). Agar intizomiy choralar va pedagogik ta'sir choralari samara bermaganda va o'quvchining maktabda qolishi boshqa o'quvchilarga salbiy ta'sir ko'rsatsa, "Bajaruvchi" xodimlarining huquqlarini poymol qilsa, shuningdek, "Bajaruvchi" normal faoliyat ko'rsatishga to'sqinlik qilsa, O'quvchini maktabdan chetlashtirish chorasi qo'llaniladi. Bunday hollarda mazkur shartnomani "Bajaruvchi"ning tashabbusi bilan bekor qilish choralari ko'rilishi mumkin bo'ladi. Agar ota-ona farzandining sog'lig'idagi jiddiy muammolarni, turli hil ruhiy kasalliklar (epelepsiya, autizm, o'ta asabiylik)ni bilib turib yashirgan bo'lsa, yil davomida ular namoyon bo'lib, atrofdagilarga zarar yetkazishi aniqlangan vaqtning o'zida shatnomani bir tomonlama bekor qilish uchun asos bo'ladi.</p>
...
<p class="article">9.1. Taraflar shartnomasi fors-major holatlari, ya'ni yengib bo'lmaydigan kuch, favqulotda va muayyan sharoitlarda oldini olib bo'lmaydigan vaziyatlar (zilzila, qo'rg'oqchilik, suv toshqini, yong'in, sel, do'l, jala, kuchaytirilgan karantin (hukumat yoki prezident qarorlari bilan tasdiqlangan kuchaytirilgan karantin holatlarida) ommaviy epidemiya va boshqa tabiiy ofatlar) tufayli majburiyatlarni bajarmagan yoki lozim darajada bajarmaganligini isbotlalsa, javobgar bo'lmaydilar.</p>
...
<p class="article">10.1. Tomonlar o'z majburiyatlarini bajarmagan yoki tegishli ravishda bajarmagan taqdirda O'zbekiston Respublikasining amaldagi qonunchiligiga muvofiq javobgar hisoblanadilar. Shartnoma shartlari yuzasidan nizo va kelishmovchiliklar tomonlar o'rtasida o'zaro xal qilinadi.</p>
...
<div class="deposit">
  ...
  <p>Shu bilan birgalikda:</p>
  <ul>
    <li>Resurslar oldindan tayyorlanadi: O'quvchi ro'yxatdan o'tgach, o'qituvchining yuklamasi, darsliklar, sinfdagi o'rni, va boshqa infratuzilma unga moslab rejalashtiriladi.</li>
    <li>Joyni band qilish kafolati: Maktabdagi har bir joy cheklangan. Depozit bu joyni boshqa o'quvchilar uchun yopib qo'yadi. Agar o'sha joy bo'sh qolsa, bu boshqa talabaning imkoniyatini yo'qqa chiqaradi.</li>
    <li>Ma'muriy xarajatlar: Har bir o'quvchi uchun shartnoma tuzish, hujjatlar yuritish, tizimga kiritish kabi ishlar mablag' va vaqt talab qiladi.</li>
    <li>O'qituvchilar va kurslar rejalashtiriladi: Depozit asosida sinflar shakllantiriladi. Keyin bekor qilish – butun guruh tuzilmasiga zarar yetkazadi.</li>
  </ul>
