export const getKidsShukranContractHtml = (data = {}) => {
  const {
    contractNumber = '___',
...
<p class="article">
  1.1. Muassasa mazkur shartnoma shartlariga asosan tarbiyalanuvchining barcha huquqlarini
  ta'minlagan holda unga sifatli ta'lim-tarbiya berish, sog'liqni muhofaza qilish va
  mustahkamlash, intellektual, axloqiy, estetik va jismoniy rivojlanishi uchun shart-sharoit
  yaratib berish majburiyatini, Ota-onalar esa tarbiyalanuvchini muassasaga topshirish,
  tarbiyalanuvchining muassasadagi ta'minoti uchun to'lovni o'z vaqtida amalga oshirish va
  Muassasaning ichki tartib-qoidalariga rioya qilish majburiyatini oladi.
</p>
...
<p class="article">2.1.2. Muassasa ustavida belgilangan tartibda Qonuniy vakil (ota-ona)ning istagidan hamda, tarbiyalanuvchining yosh xususiyatidan kelib chiqib bolani guruhga taqsimlash;</p>
...
<p class="article">2.2.9. Qonuniy vakil (ota-ona)larni muassasani kun tartibi, ta'lim-tarbiya dasturlari ilova qilinadi, muassasaning manzili va telefoni hamda ta'limni boshqaruv idorasi bilan tanishtirish;</p>
<p class="article">2.2.10. Muassasaning barcha xodimlari tomonidan qo'pol muomalada bo'lmaslik hamda bolaning ruhiyatiga salbiy ta'sir ko'rsatadigan munosabatda bo'lmaslik;</p>
...
<p class="article">2.4.4. Tarbiyalanuvchi betob bo'lganda, zudlik bilan muassasa ma'muriyati yoki tibbiy hamshiraga xabar berish va tarbiyalanuvchi sog'ayganidan so'ng tibbiy ma'lumotnomani taqdim etish;</p>
...
<p class="article">2.4.6. Mazkur shartnoma imzolangandan so'ng tarbiyalanuvchining qonuniy vakillari shartnomada ko'rsatilgan to'lovni 3 kun ichida to'lash;</p>
...
<p class="article">2.4.13. Tarbiyalanuvchining tug'ilgan kuni va tadbirlarini nishonlash uchun uy sharoitida tayyorlangan oziq-ovqat mahsulotlari hamda pishiriqlarini Muassasaga olib kirmaslik.</p>
<p class="article">2.4.14. Ota-onaning oldindan bergan yozma arizasiga asosan, bolaning muassasaga qatnashi butunlay to'xtatilgan taqdirda, to'lov to'liq bo'lmagan oy uchun, ya'ni bola amalda muassasaga qatnagan kunlar uchun qayta hisoblanib to'lov amalga oshiriladi.</p>
...
<p class="article">3.7. Muassasadan qarzdorlik paydo bo'lgan sanadan qarzdorlikni bartaraf etish uchun 10 kun mobaynida Muassasadagi bola ta'minoti uchun mavjud bo'lgan qarzdorlik qoplanganda, tarbiyalanuvchi ushbu Muassasaga tiklanadi. Ko'rsatilgan muddatdan o'tib ketgan taqdirda Muassasaga bolani qabul qilish umumiy asoslarda amalga oshiriladi.</p>
<p class="article">3.8. Shartnomaning 1 va 3.2 bandida ko'rsatilgan oylik to'lovi miqdori Muassasaning ichki imkoniyatlari, ustavi va kelgusi davr xarajatlarini inobatga olgan holda, Muassasa tomonidan o'zgartirilishi mumkin, bunda Muassasa buyurtmachini kamida yigirma kun oldin xabardor qilgan holda amalga oshiriladi va mazkur shartnomaga qo'shimcha kelishuv qilinadi.</p>
...
<p class="article">5.1. Taraflar shartnomani o'zgartirish va bekor qilishni mazkur shartnomada nazarda tutilgan hollarda va qonunchilik hujjatlari asosida amalga oshiriladi.</p>
<p class="article">5.2. Shartnoma bajarilishini bir taraflama rad etishga yoki shartnoma shartlarini bir taraflama o'zgartirishga faqat mazkur shartnoma va qonunchilik hujjatlariga asosan yo'l qo'yiladi.</p>
...
<p class="article">8.1. Mazkur shartnoma imzolangan kundan kuchga kiradi, ${contractEndDate}-yilgacha amal qiladi.</p>
<p class="article">8.2. Mazkur shartnoma ikki nusxada tuzildi, ikki nusxa bir xil yuridik kuchga ega, muassasa hamda Qonuniy vakil (ota-ona)larda bir nusxadan saqlanadi.</p>
