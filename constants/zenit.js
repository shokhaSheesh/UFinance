export const getBrightChildrensContractHtml = (data = {}) => {
  const {
    contractNumber = '___',
...
<h1>"BRIGHT CHILDRENS" MCHJ<br/>
maktabgacha ta'lim tashkiloti va ota-ona o'rtasidagi<br/>
tuzilgan</h1>
...
<p class="intro">
  <span class="bold">"BRIGHT CHILDRENS" MCHJ</span> maktabgacha ta'lim tashkiloti (keyingi o'rinlarda —
  Bajaruvchi) nomidan ustav asosida faoliyat yurituvchi direktor <span class="bold"> Fayziyeva Sh.N </span> bir
...
<p class="article">2.18. Buyurtmachidan bola ehtiyoji uchun zarur bo'lgan narsalar va boshqa maqsadlarda majburiy tarzda pul yig'maslik;</p>
<p class="article">2.19. Tarbiyalanuvchini Buyurtmachi bilan Chet-el va viloyatlarga yoki boshqa har qanday ish bilan safarga chiqishi hamda buning natijasida tarbiyalanuvchining Tashkilotga kelmagan har bir kuni uchun mazkur Shartnomaning 3.2-bandida ko'rsatilgan to'lovlarni to'lashdan ozod etmaydi.</p>
<p class="article">2.20. Belgilangan sanitariya qoidalari, normalari va gigiyena normativlari asosida sifatli oziq-ovqat mahsulotlari bilan ta'minlash;</p>
...
<p class="sub-title">Buyurtmachi quyidagi huquqlarga ega:</p>
...
<p class="article">2.38. Tashkilot ishchi xodimlari va boshqa ota-onalarni hurmat qilish;</p>
<p class="article">2.39. Tarbiyalanuvchini to'laqonli ovqatlanishini, ularda shaxsiy gigiyena ko'nikmalarni shakllantirilishini qat'iy kuzatib borish hamda tarbiyalanuvchini tashkilotga ozoda kiyingan holda olib kelish;</p>
<p class="article">2.40. Tarbiyalanuvchining tug'ilgan kuni va tadbirlarni nishonlash uchun uy sharoitida tayyorlangan oziq-ovqat mahsulotlari hamda pishiriqlarni tashkilotga olib kirmaslik;</p>
<p class="article">2.41. Tashkilotga bolani har qanday qimmatbaho taqinchoqlar, uyali aloqa vositalari va boshqa texnika vositalari bilan olib kelmaslik;</p>
<p class="article">2.42. Yashash joyi yoki telefon raqami o'zgargan taqdirda, Tashkilot rahbariyati va guruh tarbiyachisiga bu haqda xabar berish;</p>
<p class="article">2.43. Bolani oilada tarbiyalash uchun zarur shart-sharoitlarni ta'minlash;</p>
<p class="article">2.44. Bolani tashkilotdan olib ketishni begona shaxslarga topshirmaslik;</p>
<p class="article">2.45. Ertalabdan bolada kasallik holatlari kuzatilgan taqdirda, muassasaga olib bormasdan shifokor ko'rigidan o'tkazish;</p>
<p class="article">2.46. Buyurtmachining oldindan bergan yozma arizasiga asosan, bolaning maktabgacha ta'lim tashkilotiga qatnashi butunlay to'xtatilgan taqdirda, to'lov to'liq bo'lmagan oy uchun, ya'ni bola amalda maktabgacha ta'lim tashkilotiga qatnagan kunlar uchun to'lanadi.</p>

<!-- ==================== 3. TO'LOV TARTIBI ==================== -->
<div class="section-title">3. To'lov (hisob-kitob) tartibi</div>

<p class="article">3.1. Shartnomaga asosan bir oylik xizmat ko'rsatish bahosi bazaviy hisoblash sistemasiga ko'ra, <span class="bold highlight ">${monthlyPayment} so'm</span> tashkil qiladi. Sizning shartnomangizdagi summa <span class="bold highlight ">${yearlyPayment} so'm</span> ni tashkil qiladi.<br/>
Oylik xizmat ko'rsatish vaqti har oyning birinchi kunidan oxirgi kunigacha bo'lgan muddatni qamrab oladi.</p>
<p class="article">3.2. To'lov har bir kelasi oy uchun joriy oyning oxirgi sanasigacha amalga oshirilishi lozim (masalan, 2025 yil oktabr oyi uchun 2025 yil 31 sentabr oyiga qadar).</p>
...
<p class="article">3.7. To'lov belgilangan muddatdan 10 (o'n) kun kechiktirilsa 11-kundan boshlab to'lov joriy oy uchun to'liq amalga oshirilmagunga qadar Tashkilot Tarbiyalanuvchini kiritmaslik huquqiga ega bo'ladi.</p>
...
<p class="article">8.1. Mazkur shartnoma imzolagan kundan boshlab kuchga kiradi va ${contractEndDate} yilga qadar amal qiladi.</p>
...
<table class="requisites">
  <tr>
    <td>
      <div class="bold">MCHJ "BRIGHT CHILDRENS"</div>
      <div>Manzil: Toshkent sh, Yunusobod tumani, Xasanboy MFY, Xasanariq ko'chasi, 2-uy</div>
      <div>Tel: +99877 022-07-20</div>
      <div>Bank: AKB "ASIA ALLIANCE BANK" Chilonzor filiali MBXO</div>
      <div>X/r: 20208000907059236004</div>
      <div>MFO: 01095</div>
      <div>STIR: 207 018 693</div>
      <br/>
      <div>Direktor: Fayziyeva Sh.N</div>
      <div style="margin-top: 6px;">M.U</div>
...
<div class="acknowledgement">
  ...
  <div class="signature-line" style="margin-top: 16px;"></div>
</div>
