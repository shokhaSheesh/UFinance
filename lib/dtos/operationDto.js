...
const operationDto = (operation) => {
  ...
  return {
    ...
    operationType: operation.tip?.[0] === 'Поступление' ? 'income' : operation.tip?.[0] === 'Выплата' ? 'payment' : operation.tip?.[0] === 'Перемещение' ? 'transfer' : operation.tip?.[0] === 'Отгрузка' ? 'shipment' : 'accrual',
