 ...
 * Период, юрлицо, валюта и проект берутся из самого бюджета;
 * `accounting_method` передаём для БДР — метод учёта выбирается на странице.
 */
export const getBudgetPlan = (budgetsId, { accounting_method } = {}) =>
  budgetsRequest('get_budget_plan', {
