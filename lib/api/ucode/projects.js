 ...
 * ============================================
 * Тело запроса:
 *   { data: { auth, method, object_data } }
 * Эндпоинт — тот же invoke_function (functionsV2), проект указывается
 * в query-параметре `project-id`.
 */

// project-id в адресе эндпоинта (см. lib/config/api.js)
