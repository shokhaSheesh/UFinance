    ...
    <div className='sm-delete-overlay' onClick={onCancel}>
      <div className='sm-delete-modal' onClick={e => e.stopPropagation()}>
        ...
        <div className='sm-delete-modal__actions'>
          <button className='sm-delete-modal__btn sm-delete-modal__btn--cancel' onClick={onCancel}>Отменить</button>
          <button className='sm-delete-modal__btn sm-delete-modal__btn--delete' onClick={onConfirm}>Удалить</button>
        </div>
      </div>
    </div>
  )
    ...
    <div className='sm-root'>
      ...
      <div className='sm-input-bar'>
          ...
          <div className='sm-input-bar__files'>
            {attachedFiles.map((file, i) => (
              <div className='sm-input-bar__file' key={i}>
                ...
                <button className='sm-input-bar__file-remove' onClick={() => onRemoveAttach(i)} title='Удалить файл'>
        ...
        <div className='sm-input-bar__row'>
          ...
          <button className='sm-input-bar__send' onClick={onSend} title='Отправить'>
            <svg width='20' height='20' viewBox='0 0 24 24' fill='none'>
