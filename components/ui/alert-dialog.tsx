...
function AlertDialog({ open, ...rest }: AlertDialogPrimitive.Root.Props) {
  const layer = useDialogLayer(open)

  return (
    <DialogLayerContext.Provider value={layer}>
      <AlertDialogPrimitive.Root data-slot="alert-dialog" open={open} {...rest} />
...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      style={{ zIndex: getOverlayZIndex(layer), ...style }}
      {...props}
    />
  )
}
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        style={{ zIndex: getContentZIndex(layer) }}
        {...props}
      />
    </AlertDialogPortal>
  )
