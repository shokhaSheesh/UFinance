  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center bg-white rounded-xl h-full min-h-[350px]">
      ...
      <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center border border-neutral-50/50">
        {icon || <Package size={32} className="text-gray-400 stroke-[1.5]" />}
      </div>
      ...
      {onAdd && canAdd && (
        <button
          ...
          className={
            buttonVariant === 'link'
              ? 'bg-transparent border-none cursor-pointer text-sm font-semibold text-primary hover:text-primary-dark transition-colors'
              : 'primary-btn'
          }
        >
