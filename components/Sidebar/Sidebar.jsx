...
export const Sidebar = observer(() => {
    ...
    if (!mounted) {
        return (
            <aside className="bg-blue-950 w-[80px] flex flex-col gap-2 h-screen z-10! items-center justify-start fixed left-0">
    ...
    return (
        <aside className="bg-blue-950 w-[80px] flex flex-col gap-2 z-10! h-screen items-center justify-star fixed left-0 " ref={sidebarRef}>
            <nav className="flex flex-col   w-full">
