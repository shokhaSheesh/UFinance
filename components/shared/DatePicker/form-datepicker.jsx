...
const FormDatepicker = ({ inputClass, className, value, onChange, format = "DD MMM, YYYY", type = null, disabled, ...props }) => {
  return <DatePicker
    portal
    value={value}
    format={format} 
    ...
    render={(value, openCalendar) => {
      return (
        <button type="button" className={`border bg-gray-ucode-25 rounded-md cursor-pointer border-gray-ucode-200 px-1.5 py-1 h-[36px] w-full gap-2 flex items-center ${inputClass} ${disabled ? 'text-gray-500' : ""}`} onClick={openCalendar}>
